      ...
      <div class="flex items-center gap-3">
        ...
        <div class="relative">
          <button 
            ...
            class="w-10 h-10 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 flex items-center justify-center font-black hover:ring-2 hover:ring-indigo-300 transition-all duration-300 shadow-sm"
          >
          ...
          <div 
            ...
            @click.stop
          >
            <NuxtLink to="/" @click="closeDropdown" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition">แกลเลอรี</NuxtLink>
            <NuxtLink :to="`/${currentUser.userRole}/profile`" @click="closeDropdown" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition">แก้ไขโปรไฟล์</NuxtLink>
